...
import io.agora.openvcall.ui.ChooseCourseChat;
import io.agora.openvcall.ui.NameRecyclerViewAdapter;
...
public class AddNewCourse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbUser = FirebaseDatabase.getInstance().getReference().child("AllCourses");
    ...
    private void initPointRequest() {
        ...
        NameRecyclerViewAdapter adapter = new NameRecyclerViewAdapter(this, mname,"n","null");
